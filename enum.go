...
// InputType is the input device type.
//
// The returned devices may not necessarily be an actual keyboard or mouse,
// etc. Just a device which can behave like one. For instance: Mouse may
// return a trackpad, a multi-touch screen and an actual mouse if all of these
// happen to be connected. It is up to the host to figure out which one to
// use.
type InputType int
...
// InputPropType is the input device property type, for determining input
...
// properties.
//
// The InputPropPointer property indicates that the device is not transposed on
...
// multi-touch device.
type InputPropType int

// Input property types.
const (
	InputPropPointer   InputPropType = 0x00
	InputPropDirect    InputPropType = 0x01
	InputPropButtonPad InputPropType = 0x02
	InputPropSemiMT    InputPropType = 0x03
...
const (
	...
	KeyKP8              KeyType = 72
	KeyKP9              KeyType = 73
	KeyKPMinus          KeyType = 74
	KeyKP4              KeyType = 75
	KeyKP5              KeyType = 76
	KeyKP6              KeyType = 77
	KeyKPPlus           KeyType = 78
	KeyKP1              KeyType = 79
	KeyKP2              KeyType = 80
	KeyKP3              KeyType = 81
	KeyKP0              KeyType = 82
	...
	KeyKPJPComma        KeyType = 95
	KeyKPEnter          KeyType = 96
	KeyRightCtrl        KeyType = 97
	KeyKPSlash          KeyType = 98
	KeySysRQ            KeyType = 99
	...
	KeyKPEqual          KeyType = 117
	KeyKPPlusMinus      KeyType = 118
	KeyPause            KeyType = 119
	KeyScale            KeyType = 120 // AL Compiz Scale (Expose)
	KeyKPComma          KeyType = 121
	...
	KeyKPLeftParen      KeyType = 179
	KeyKPRightParen     KeyType = 180
	...
	KeyFN               KeyType = 0x1d0
	KeyFNEsc            KeyType = 0x1d1
	KeyFNF1             KeyType = 0x1d2
	KeyFNF2             KeyType = 0x1d3
	KeyFNF3             KeyType = 0x1d4
	KeyFNF4             KeyType = 0x1d5
	KeyFNF5             KeyType = 0x1d6
	KeyFNF6             KeyType = 0x1d7
	KeyFNF7             KeyType = 0x1d8
	KeyFNF8             KeyType = 0x1d9
	KeyFNF9             KeyType = 0x1da
	KeyFNF10            KeyType = 0x1db
	KeyFNF11            KeyType = 0x1dc
	KeyFNF12            KeyType = 0x1dd
	KeyFN1              KeyType = 0x1de
	KeyFN2              KeyType = 0x1df
	KeyFND              KeyType = 0x1e0
	KeyFNE              KeyType = 0x1e1
	KeyFNF              KeyType = 0x1e2
	KeyFNS              KeyType = 0x1e3
	KeyFNB              KeyType = 0x1e4
	KeyBRLDot1          KeyType = 0x1f1
	KeyBRLDot2          KeyType = 0x1f2
	KeyBRLDot3          KeyType = 0x1f3
	KeyBRLDot4          KeyType = 0x1f4
	KeyBRLDot5          KeyType = 0x1f5
	KeyBRLDot6          KeyType = 0x1f6
	KeyBRLDot7          KeyType = 0x1f7
	KeyBRLDot8          KeyType = 0x1f8
	KeyBRLDot9          KeyType = 0x1f9
	KeyBRLDot10         KeyType = 0x1fa
